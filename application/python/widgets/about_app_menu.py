...
class AboutAppMenu(QDialog):
    def __init__(self, overlay, parent):
        ...
        # Заголовок
        self.header = QLabel("About app", self)
        ...
        self.web_app_url = "https://www.example.com"

        self.text_description = f"""
            This project of voice assistant aims to help with interacting with your operating system and automating routine tasks.<br>
            <br>
            This means that you can say or text in chat: "Hey Tyler, play some music" or "Hey Tyler, set the alarm for 8 a.m.".<br>
            Click the button below to open the documentation and see full list of assistant functions.<br>
            <br>
            There is also a web version of the assistant. Follow the <a href="{self.web_app_url}">link</a> to use it.<br>
        """
        ...
        self.open_documentation_button = QPushButton("Open documentation", self)
        self.open_documentation_button.setStyleSheet("""
            QPushButton {
                font-size: 14px;
        ...
        """)
        self.open_documentation_button.clicked.connect(self.open_documentation)
        self.bottom_layout.addWidget(self.open_documentation_button)
